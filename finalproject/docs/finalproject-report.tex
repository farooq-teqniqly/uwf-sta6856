...
The dataset, the R analysis script and the PySpark notebook are also available for download via a public GitHub release at \url{https://github.com/farooq-teqniqly/uwf-sta6856/releases/tag/final-project-v1.8/finalproject.zip}
